...
pub const IVoiceCallback = extern struct {
    ...
    pub const VTable = extern struct {
        ...
        OnVoiceProcessingPassStart: *const fn (*T, UINT32) callconv(WINAPI) void = _onVoiceProcessingPassStart,
        OnVoiceProcessingPassEnd: *const fn (*T) callconv(WINAPI) void = _onVoiceProcessingPassEnd,
        OnStreamEnd: *const fn (*T) callconv(WINAPI) void = _onStreamEnd,
        OnBufferStart: *const fn (*T, ?*anyopaque) callconv(WINAPI) void = _onBufferStart,
        OnBufferEnd: *const fn (*T, ?*anyopaque) callconv(WINAPI) void = _onBufferEnd,
        OnLoopEnd: *const fn (*T, ?*anyopaque) callconv(WINAPI) void = _onLoopEnd,
        OnVoiceError: *const fn (*T, ?*anyopaque, HRESULT) callconv(WINAPI) void = _onVoiceError,
    };
